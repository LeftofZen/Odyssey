...
{
	public static class SpriteBatchStringExtensions
	{
		public static void DrawDebugStringCentered(this SpriteBatch sb, SpriteFont sf, string str, Vector2 pos, Color color, float scale = 1f)
		{
		...
		public static void DrawDebugStringLeftAligned(this SpriteBatch sb, SpriteFont sf, string str, Vector2 pos, Color color, float scale = 1f)
		{
			var size = sf.MeasureString(str);
